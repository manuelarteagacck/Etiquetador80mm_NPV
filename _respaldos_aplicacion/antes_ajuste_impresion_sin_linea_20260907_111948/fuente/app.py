...
def _estimate_label_height_dots(
    ...
    La linea divisoria superior se toma como inicio visual de cada etiqueta y
    solo se conserva un margen pequeno despues del ultimo elemento impreso.
    """
    ...
    y_pos = _param_int(params, "top_y", 20 if section == "normal" else 64, 0)
    content_bottom = divider_bottom
...
class LabelPrintPreviewWindow(tk.Toplevel):
    def __init__(self, parent, item: Dict[str, Any], individual: bool = False):
        ...
        if self.item.get("PRECIO_ESPECIAL"):
            ...
            # Alto exclusivo de la vista previa. La etiqueta normal necesita
            # espacio adicional para mostrar completo el texto bajo el codigo
            # de barras; esto no modifica medidas ni coordenadas de impresion.
            label_height = 360 if individual else 380
